...
<body>
	...
	<div class="container">
        ...
        <nav class="col-lg-12 tiny-menu text-center" style="margin-top:100px;">
            <a href="<?=base_url()?>index.php/work" class="col-lg-2 col-lg-offset-4">Work</a>
            <a href="<?=base_url()?>index.php/blog" class="col-lg-1 active">Blog</a>
        </nav>

		<div class="content-container col-lg-8 col-lg-offset-2 clearfix">

			<?php foreach ($articles as $item) { ?>
				<a class="thumbnail clearfix" style="text-decoration:none;color:inherit;" href="<?=base_url()?>index.php/blog/article/<?=$item->id?>">
